...
@media (max-width: 767px){
  ...
  <header class="masthead mb-auto">
    <div class="inner">
      ...
      <nav class="nav nav-masthead justify-content-center">
        ...
        <a class="nav-link active" href="mensalidades.php"> Pagar Mensalidade </a>
  ...
  <!-- <main id="main" role="main" class="inner cover">
    ...
    <p class="lead">
      <a class="btn btn-lg btn-secondary" href="mensalidades.php">Pagar Mensalidade  </a>
    </p>
    <p class="lead">
      <a class="btn btn-lg btn-secondary" href="divida.php">Negociação de Dívida </a>
    </p>
    <p class="lead">
      <a class="btn btn-lg btn-secondary" href="rematricula.php"> Rematrícula </a>
      <a class="btn btn-lg btn-secondary" href="rematricula-com-divida.php"> Rematrícula com Dívida</a>
    </p>
  </main> -->
