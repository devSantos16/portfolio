...
.btn-circle {
  ...
  <header class="masthead mb-auto">
    <div class="inner">
      ...
      <nav class="nav nav-masthead justify-content-center">
        ...
        <a class="nav-link active" href="rematricula.php"> Rematrícula </a>
 ...
 <div class="col-md-12">
     <div class="text-center">
        <img src="../img/rematricula-divida.png" alt="img rematricula" width="1000px" height="500px">
     </div><br>
     <div class="row col-md-12 text-center">
     <div class="col-md-6">
        <button ype="button" class="btn btn-warning btn-circle btn-xl">
           <img src="../img/icon.png" alt="icon exemple" width="55px" height="55px">
        </button>
        <br>
        <a href="extrato.php" style="color:gold;font-size:20px;"> Extrato</a>  
     </div>
     <div class="col-md-6">
        <button ype="button" class="btn btn-warning btn-circle btn-xl">
