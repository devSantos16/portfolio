...
@media (max-width: 767px){
  ...
  <main id="main" role="main" class="inner cover">
    <h1 class="cover-heading"> ANTUNES</h1>
    <h2 class="cover-heading"> TECHNOLOGY AND DEVELOPMENT</h2>
    <p class="lead">Site ainda em Desenvolvimento qualquer dúvida entre em contato.</p>
    <p class="lead">
