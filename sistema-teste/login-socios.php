...
.cont {
  position: relative;
  height: 100%;
  background-image: url("https://static.wixstatic.com/media/fa2789_e5a40a81e7b84935879e3e3d13acba69.jpg");
...
<body>
<form href="index-admin.php"action="" method="post">
  <div href="index-admin.php" class="cont">
    <div href="index-admin.php" class="demo">
      <div href="index-admin.php" class="login">
        <divhref="index-admin.php" >
          <img align="text-center" valign="center" src="img\logo.png" width="300px" height="250px">
        </div>
        <div href="index-admin.php" class="login__form">
          <div href="index-admin.php" class="login__row">
            <svg href="index-admin.php" class="login__icon name svg-icon" viewBox="0 0 20 20">
              <path href="index-admin.php" d="M0,20 a10,8 0 0,1 20,0z M10,0 a4,4 0 0,1 0,8 a4,4 0 0,1 0,-8"></path>
            </svg>
            <input href="index-admin.php" name="txtlogin" type="email" class="login__input name" placeholder="Username">
          </div>
          <div href="index-admin.php" class="login__row">
            <svg href="index-admin.php" class="login__icon pass svg-icon" viewBox="0 0 20 20">
              <path href="index-admin.php"  d="M0,20 20,20 20,8 0,8z M10,13 10,16z M4,8 a6,8 0 0,1 12,0"></path>
            </svg>
            <input href="index-admin.php"  name="txtsenhal" type="password" class="login__input pass" placeholder="Password">
          </div>
          <button onclick="window.location.href='index-admin.php'" class="login__submit">Entrar</button>
          <h2><a href="index-admin.php"> CLIQUE AQUI PARA AVANÇAR </a></h2>
          <!-- <button  name="entrar" type="submit" class="login__submit">Entrar</button> -->
        </div>
      </div>
    </div>
  </div>
...
<!--
<?php
          include 'modelo/socios.class.php';
          include 'dao/sociodao.class.php';
          include_once 'util/seguranca.class.php';
          include_once 'util/validacao.class.php';

          $s = new Socios();
          $s->emailSocios = $_POST['txtlogin'];
          $s->senhaSocios = Seguranca::criptografar($_POST['txtsenhal']);
          if($emailSocios == "" || $senhaSocios == ""){
            echo "<script> alert('<h2>Usuário/senha incompleto(s)!</h2>')";
          }else{
            $sociosDAO = new SociosDAO();
            $socios = $sociosDAO->verificarSocios($s);
            if($socios != null){
              $_SESSION['privateUser'] = serialize($socios);
              $_SESSION['msg'] = "Bem vindo sócio!";
